...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  printKeyHash();
...

        {
            ...
            alertDialog.show();
            alertDialog.setMessage("Porfavor espere...");
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // builder.create().dismiss();
                ...
                {
                    Toast.makeText(MainActivity.this, "Porfavor ingrese su Dirección",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(edt_birthdate.getText().toString()))
                {
                    Toast.makeText(MainActivity.this, "Porfavor ingrese su Fecha de Nacimiento",Toast.LENGTH_SHORT).show();
                    return;
                }
                if(TextUtils.isEmpty(edt_name.getText().toString()))
                {
                    Toast.makeText(MainActivity.this, "Porfavor ingrese su Nombre ",Toast.LENGTH_SHORT).show();
                    return;
                }
   ...
   /* private void printKeyHash() {
        try
        {
            PackageInfo info = (PackageInfo) getPackageManager().getPackageInfo("com.example.flumpto_rest" , PackageManager.GET_SIGNATURES);
